...
## 示例图片
|聚合推荐|聚合剧场|短剧滑滑流|短剧详情|
|--|--|--|--|
| <img src={normalizeImagePath('/imgs/adcontent/img_theater_1.webp')}/> | <img src={normalizeImagePath('/imgs/adcontent/img_theater_2.webp')}/> | <img src={normalizeImagePath('/imgs/adcontent/img_theater_3.webp')}/>| <img src={normalizeImagePath('/imgs/adcontent/img_detail.webp')}/>|
...
> 详情页出了这些参数可实现个性化之外，如果想要自定义短剧详情，可以使用[短剧详情 Widget 组件](/start/guide/adcontent/widgets)来实现

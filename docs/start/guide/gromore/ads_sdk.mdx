...
- 隐私合格约来约严格，越来越规范了，苹果这方面做的比较好，具体查看这个官方文档[《Apple-隐私清单文件》](https://developer.apple.com/documentation/bundleresources/privacy_manifest_files)
